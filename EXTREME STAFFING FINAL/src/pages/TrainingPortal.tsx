  ...
  const courses: Course[] = [
    {
      ...
      description: "Essential orientation for all new event staff covering company policies, dress code, and expectations."
    },
    {
      id: "CRS-002",
      ...
      status: "in-progress",
      required: true,
      instructor: "Chef Robert Taylor",
      description: "Learn proper food safety protocols, temperature control, and hygiene standards for event catering."
    },
    {
      id: "CRS-003",
      ...
      description: "Master the art of providing exceptional customer service at high-end events."
    },
    {
      id: "CRS-004",
      title: "Alcohol Service Certification",
      category: "Compliance",
      duration: 120,
      modules: 12,
      completionRate: 100,
      ...
      description: "TIPS certification training for responsible alcohol service, ID checking, and intervention techniques."
    },
    {
      id: "CRS-005",
      ...
      description: "Efficient techniques for setting up event spaces, arranging tables, and post-event cleanup."
    },
    {
      id: "CRS-006",
      ...
      description: "Critical protocols for handling emergencies, evacuations, and medical situations during events."
    },
    {
      id: "CRS-007",
      ...
      description: "Master formal service styles including French, Russian, and American plated service."
    },
    {
      id: "CRS-008",
      ...
      required: true,
      instructor: "HR Team",
      description: "Mandatory training on recognizing, preventing, and reporting workplace harassment."
    }
  ];

  // Mock staff progress (for admin view)
  const staffProgress: StaffProgress[] = [
    {
      ...
      coursesCompleted: 5,
      coursesInProgress: 2,
      overallCompletion: 87.5,
      badges: ["Food Safety", "Alcohol Service", "Customer Excellence"]
    },
    {
      staffId: "ST-102",
      ...
      badges: ["Food Safety", "Emergency Response"]
    },
    {
      staffId: "ST-103",
