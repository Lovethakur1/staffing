...
import { clientData, invoiceData } from "../data/clientData";
...
export function Clients({ userRole }: ClientsProps) {
  ...
  const allClients: ClientData[] = clientData;
  
  // Mock comprehensive invoice data
  const allInvoices: Invoice[] = invoiceData;
      ...
      <div className="max-w-[1800px] mx-auto p-6 space-y-6">
        ...
        <div className="flex flex-col gap-4">
          <div className="flex items-center justify-between">
            ...
            <Button onClick={() => toast.success("Add client feature coming soon")}>
