...
import svgPaths from "../../imports/svg-v6lx6ue6rh";
import { Badge } from "../ui/badge";
import { Button } from "../ui/button";
import clsx from "clsx";
import { motion, AnimatePresence } from "motion/react";
import { Clock, Briefcase, MapPin, Navigation, Coffee, Home, Building2, Car } from "lucide-react";
import googleMapBg from "figma:asset/3a8b8a7d2dac090ff0ac2aaf5760732acab67c7f.png";
      ...
      <div className="relative flex-grow w-full overflow-hidden group bg-[#f8fafc]">
                ...
                <div className="relative w-[872px] h-[528px]">
                    ...
                    <div className="absolute inset-0 w-full h-full pointer-events-none z-10">
                        <svg className="block w-full h-full" fill="none" preserveAspectRatio="none" viewBox="0 0 872.672 528">
                            ...
                            <path d={svgPaths.p23279200} stroke="url(#paint0_linear_8007_2431)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="6.54504" />
                            
                            {/* Static Waypoints */}
                            <path d={svgPaths.p492c9f0} fill="white" stroke="#4338CA" strokeWidth="3.27252" />
                            <path d={svgPaths.p2a3b3000} fill="white" stroke="#4338CA" strokeWidth="3.27252" />
                            <path d={svgPaths.p2196f0c0} fill="white" stroke="#4338CA" strokeWidth="3.27252" />
                            <path d={svgPaths.p77b2a00} fill="#4338CA" stroke="white" strokeWidth="2.18168" />
                        </svg>
                    </div>
                        ...
                        >
                             <div className="flex items-center justify-center relative shrink-0 size-[40px] transform rotate-45">
                                 <svg className="block w-full h-full" fill="none" preserveAspectRatio="none" viewBox="0 0 28 28">
                                     <path d={svgPaths.p19d2180} fill="white" stroke="white" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.35" />
                                 </svg>
                             </div>
                        </motion.div>
                    </motion.div>
        ...
        <div className="absolute top-4 right-4 flex flex-col gap-2 z-50">
           ...
           <button onClick={() => setZoom(1)} className="h-[32px] w-[32px] bg-white rounded-lg shadow-sm border border-[#f1f5f9] flex items-center justify-center hover:bg-slate-50 relative">
               <Icon className="w-4 h-4"><path d={svgPaths.p1bd16b80} fill="#0F172B" stroke="#0F172B" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" /></Icon>
