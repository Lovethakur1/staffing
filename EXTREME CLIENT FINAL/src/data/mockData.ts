...
export interface User {
  ...
  email: string;
  phone: string;
  role: 'client' | 'staff' | 'admin' | 'manager';
  avatar?: string;
  createdAt: string;
}
...
export interface FavoriteEvent {
  ...
  // Venue location details for auto-fill
  venueName?: string;
  venueAddress?: string;
  venueCity?: string;
  venueState?: string;
...
export const mockUsers: User[] = [
  ...
  },
  {
    id: 'client-3',
    name: 'Emily Davis',
    email: 'emily@corporateevents.com',
    phone: '+1-555-0129',
    role: 'client',
...
export const mockEvents: Event[] = [
  ...
  // Upcoming events for client-1 (future dates)
  {
    id: 'event-upcoming-1',
    clientId: 'client-1',
    managerId: 'manager-1',
    title: 'Annual Company Retreat',
    description: 'Multi-day corporate retreat with team building activities, meals, and networking for 150 employees',
    eventType: 'Corporate Event',
    venue: 'Palm Springs Resort & Spa',
    date: '2025-11-20',
    time: '09:00 - 18:00',
    startTime: '09:00',
    endTime: '18:00',
    location: 'Palm Springs Resort & Spa, California',
    status: 'confirmed',
    staffRequired: 12,
    assignedStaff: ['staff-1', 'staff-2', 'staff-3', 'staff-4', 'staff-5', 'staff-6', 'staff-7', 'staff-8', 'staff-9', 'staff-10', 'staff-11', 'staff-12'],
    budget: 8500,
    deposit: 2550,
    tips: 500,
    specialRequirements: 'Outdoor event experience, ability to work in resort setting, team-oriented mindset'
  },
  {
    id: 'event-upcoming-2',
    clientId: 'client-1',
    managerId: 'manager-2',
    title: 'Holiday Gala & Awards Ceremony',
    description: 'Elegant holiday celebration with awards, dinner and dance event for 200 guests with live music and 4-course meal',
    eventType: 'Gala',
    ...
    deposit: 4500,
    tips: 1000,
    specialRequirements: 'Fine dining experience required, holiday event management, coordinated team service'
  },
  {
    id: 'event-upcoming-3',
    clientId: 'client-1',
    managerId: 'manager-1',
    title: 'New Year Product Showcase',
    description: 'Product launch event with demonstrations, networking, and cocktail reception for 120 industry professionals',
    eventType: 'Product Launch',
    ...
    startTime: '17:00',
    endTime: '21:00',
    location: 'Downtown Los Angeles Conference Center',
    status: 'confirmed',
    staffRequired: 10,
    assignedStaff: ['staff-5', 'staff-10', 'staff-15', 'staff-20', 'staff-25', 'staff-30', 'staff-35', 'staff-40', 'staff-41', 'staff-42'],
    budget: 7200,
    deposit: 2160,
    tips: 400,
    specialRequirements: 'Professional presentation skills, tech-savvy, experience with product launches'
  },
  {
    id: 'event-upcoming-4',
    clientId: 'client-1',
    ...
    description: 'Private executive dining experience with 5-course tasting menu for 30 board members',
    eventType: 'Corporate Event',
    venue: 'Private Dining Room - The Peninsula',
    date: '2025-11-25',
    time: '19:00 - 23:00',
    startTime: '19:00',
    endTime: '23:00',
    ...
    status: 'confirmed',
    staffRequired: 6,
    assignedStaff: ['staff-1', 'staff-3', 'staff-5', 'staff-7', 'staff-9', 'staff-11'],
    budget: 5500,
    deposit: 1650,
    tips: 350,
    specialRequirements: 'White glove service, fine dining expertise, discretion with confidential discussions'
  },
  {
    id: 'event-upcoming-5',
    clientId: 'client-1',
    ...
    description: 'Employee recognition event with awards presentation, dinner, and entertainment for 250 staff members',
    eventType: 'Corporate Event',
    venue: 'Universal CityWalk Event Space',
    date: '2025-12-20',
    time: '18:00 - 22:00',
    startTime: '18:00',
    endTime: '22:00',
    location: 'Universal Studios CityWalk, Los Angeles',
    status: 'pending',
    staffRequired: 18,
    assignedStaff: ['staff-2', 'staff-4', 'staff-6', 'staff-8', 'staff-10', 'staff-12'],
    budget: 12000,
    deposit: 3600,
    specialRequirements: 'Event coordination experience, ability to manage ceremony logistics, professional demeanor'
  },
  // Pending events
  {
    id: 'event-pending-1',
  ...
  // More Upcoming Events for variety
  {
    id: 'event-upcoming-8',
    clientId: 'client-1',
    managerId: 'manager-1',
    title: 'Quarterly Business Review',
    description: 'Executive quarterly business review with presentation and working lunch for 40 senior managers',
    eventType: 'Corporate Meeting',
    ...
    startTime: '09:00',
    endTime: '16:00',
    location: 'Century Park Towers, Century City',
    status: 'confirmed',
    staffRequired: 6,
    assignedStaff: ['staff-1', 'staff-3', 'staff-5', 'staff-7', 'staff-9', 'staff-11'],
    budget: 4200,
    deposit: 1260,
    tips: 300,
    specialRequirements: 'Executive-level service, confidentiality required, business professional attire',
    requirements: 'Executive-level service, confidentiality required, business professional attire'
  },
  {
    id: 'event-upcoming-9',
    clientId: 'client-1',
    managerId: 'manager-2',
    title: 'Valentine\'s Day Charity Ball',
    description: 'Romantic charity ball with five-course dinner, live orchestra, and silent auction for 300 guests',
    eventType: 'Charity Gala',
    ...
    startTime: '18:00',
    endTime: '24:00',
    location: 'Biltmore Hotel Grand Ballroom, Downtown LA',
    status: 'confirmed',
    staffRequired: 28,
    assignedStaff: ['staff-1', 'staff-2', 'staff-3', 'staff-4', 'staff-5', 'staff-6', 'staff-7', 'staff-8', 'staff-9', 'staff-10', 'staff-11', 'staff-12', 'staff-13', 'staff-14', 'staff-15', 'staff-16', 'staff-17', 'staff-18', 'staff-19', 'staff-20', 'staff-21', 'staff-22', 'staff-23', 'staff-24', 'staff-25', 'staff-26', 'staff-27', 'staff-28'],
    budget: 19500,
    deposit: 5850,
    tips: 1400,
    specialRequirements: 'Black tie mandatory, fine dining experience, romantic ambiance awareness',
    requirements: 'Black tie mandatory, fine dining experience, romantic ambiance awareness'
  },
  {
    id: 'event-upcoming-10',
    clientId: 'client-1',
    managerId: 'manager-1',
    title: 'Spring Product Showcase',
    description: 'Interactive product showcase with demo stations, networking hour, and media coverage for 200 attendees',
    eventType: 'Product Launch',
    venue: 'Innovation Hub',
    date: '2025-03-20',
    time: '14:00 - 21:00',
    ...
    status: 'confirmed',
    staffRequired: 16,
    assignedStaff: ['staff-2', 'staff-4', 'staff-6', 'staff-8', 'staff-10', 'staff-12', 'staff-14', 'staff-16', 'staff-18', 'staff-20', 'staff-22', 'staff-24', 'staff-26', 'staff-28', 'staff-30', 'staff-32'],
    budget: 11200,
    deposit: 3360,
    tips: 750,
    specialRequirements: 'Tech-savvy, product knowledge helpful, modern cocktail service',
    requirements: 'Tech-savvy, product knowledge helpful, modern cocktail service'
  },
  {
    id: 'event-upcoming-11',
    clientId: 'client-1',
    managerId: 'manager-2',
    title: 'Annual Shareholders Meeting',
    description: 'Corporate annual shareholders meeting with continental breakfast, lunch, and networking reception for 150 shareholders',
    eventType: 'Corporate Event',
    ...
    startTime: '08:00',
    endTime: '17:00',
    location: 'Corporate Headquarters Auditorium, El Segundo',
    status: 'confirmed',
    staffRequired: 12,
    assignedStaff: ['staff-1', 'staff-5', 'staff-9', 'staff-13', 'staff-17', 'staff-21', 'staff-25', 'staff-29', 'staff-33', 'staff-37', 'staff-41', 'staff-45'],
    budget: 8900,
    deposit: 2670,
    tips: 600,
    specialRequirements: 'Corporate event experience, professional business attire, discretion',
    requirements: 'Corporate event experience, professional business attire, discretion'
  },
  {
    id: 'event-upcoming-12',
    clientId: 'client-1',
    managerId: 'manager-1',
    title: 'Summer Music Festival VIP Area',
    description: 'VIP hospitality area at music festival with premium bar service and lounge for 80 VIP guests',
    ...
    startTime: '12:00',
    endTime: '23:00',
    location: 'LA State Historic Park, Chinatown',
    status: 'confirmed',
    staffRequired: 14,
    assignedStaff: ['staff-2', 'staff-6', 'staff-10', 'staff-14', 'staff-18', 'staff-22', 'staff-26', 'staff-30', 'staff-34', 'staff-38', 'staff-42', 'staff-46', 'staff-48', 'staff-50'],
    budget: 9800,
    deposit: 2940,
    tips: 850,
    specialRequirements: 'Outdoor event experience, high-energy environment, premium cocktail knowledge',
    requirements: 'Outdoor event experience, high-energy environment, premium cocktail knowledge'
  },
  {
    id: 'event-pending-8',
    clientId: 'client-1',
    ...
    description: 'Three-day executive leadership retreat with meals, team building, and evening receptions for 50 executives',
    ...
    budget: 15000,
    deposit: 4500,
    specialRequirements: 'Multi-day event experience, resort environment, executive-level service',
    requirements: 'Multi-day event experience, resort environment, executive-level service'
  },
  {
    id: 'event-pending-9',
    clientId: 'client-1',
    ...
    description: 'Industry recognition awards ceremony with red carpet, seated dinner, and after-party for 250 industry professionals',
    ...
    status: 'pending',
    staffRequired: 22,
    assignedStaff: ['staff-2', 'staff-4', 'staff-6', 'staff-8'],
    budget: 16500,
    deposit: 4950,
    specialRequirements: 'Red carpet event experience, celebrity handling, formal attire mandatory',
    requirements: 'Red carpet event experience, celebrity handling, formal attire mandatory'
  },
  {
    id: 'event-pending-10',
    clientId: 'client-1',
    ...
    description: 'Healthcare technology innovation summit with keynote speakers, breakout sessions, and networking for 400 attendees',
    ...
    status: 'pending',
    staffRequired: 25,
    assignedStaff: ['staff-5', 'staff-10', 'staff-15'],
    budget: 18000,
    deposit: 5400,
    specialRequirements: 'Healthcare environment experience, professional demeanor, long hours capability',
    requirements: 'Healthcare environment experience, professional demeanor, long hours capability'
  },
  {
    id: 'event-pending-11',
    clientId: 'client-1',
    managerId: 'manager-2',
    title: 'Fall Fashion Week After-Party',
    description: 'Exclusive fashion week after-party with DJ, premium cocktails, and networking for 180 fashion industry insiders',
    ...
    startTime: '21:00',
    endTime: '03:00',
    location: 'E.P. & L.P. Rooftop, West Hollywood',
    status: 'pending',
    staffRequired: 15,
    assignedStaff: ['staff-7', 'staff-14'],
    budget: 10500,
    deposit: 3150,
    specialRequirements: 'Late night availability, fashion industry knowledge, trendy cocktail service',
    requirements: 'Late night availability, fashion industry knowledge, trendy cocktail service'
  },
  {
    id: 'event-pending-12',
    clientId: 'client-1',
    managerId: 'manager-1',
    title: 'Oktoberfest Corporate Celebration',
    description: 'Oktoberfest themed corporate party with German food, beer service, and live music for 220 employees',
    ...
    status: 'pending',
    staffRequired: 18,
    assignedStaff: ['staff-3', 'staff-9'],
    budget: 12800,
    deposit: 3840,
    specialRequirements: 'Beer service knowledge, theme party experience, high-energy environment',
    requirements: 'Beer service knowledge, theme party experience, high-energy environment'
  }
];
    ...
    favoriteEvents: [
      {
        ...
        rating: 5,
        venueName: 'Hilton Hotel Grand Ballroom',
        venueAddress: '486 Hilton Way',
      ...
      },
      {
        ...
        venueAddress: '695 Riverside Drive',
        venueCity: 'Burbank',
        venueState: 'CA',
        venueZipCode: '91505'
      },
      {
        ...
        rating: 4.9,
        venueName: 'Four Seasons Ballroom',
        venueAddress: '852 Seasons Boulevard',
        venueCity: 'Beverly Hills',
        venueState: 'CA',
        venueZipCode: '90210'
      },
      {
        ...
        rating: 4.7,
        venueName: 'Botanical Event Center',
        venueAddress: '321 Botanical Drive',
        venueCity: 'Pasadena',
        venueState: 'CA',
        venueZipCode: '91101'
      },
      {
        ...
        rating: 4.6,
        venueName: 'Metropolitan Ballroom',
        venueAddress: '573 Metro Avenue',
      ...
      },
      {
        ...
        rating: 4.8,
        venueName: 'Rooftop Venue Downtown',
        venueAddress: '716 Rooftop Plaza',
        venueCity: 'Los Angeles',
        venueState: 'CA',
        venueZipCode: '90017'
      },
      {
        ...
        rating: 4.9,
        venueName: 'Tranquility Gardens',
        venueAddress: '261 Tranquil Lane',
      ...
      },
      {
        ...
        venueAddress: '927 Ocean Boulevard',
        venueCity: 'Santa Monica',
        venueState: 'CA',
        venueZipCode: '90405'
      },
      {
        ...
        venueAddress: '258 Convention Plaza',
        venueCity: 'Los Angeles',
        venueState: 'CA',
        venueZipCode: '90015'
      },
      {
        ...
        venueAddress: '827 Skyline Avenue',
        venueCity: 'Los Angeles',
        venueState: 'CA',
        venueZipCode: '90014'
      }
    ...
    favoriteEvents: [
      {
        ...
        rating: 4.5,
        venueName: 'Sunset Boulevard Events',
        venueAddress: '938 Sunset Boulevard',
      ...
      },
      {
        ...
        rating: 4.7,
        venueName: 'Wilshire Grand Ballroom',
        venueAddress: '837 Wilshire Boulevard',
        venueCity: 'Los Angeles',
        venueState: 'CA',
        venueZipCode: '90017'
      },
      {
        ...
        rating: 4.6,
        venueName: 'Grand Luxe Hotel Ballroom',
        venueAddress: '159 Grand Avenue',
        venueCity: 'Los Angeles',
        venueState: 'CA',
        venueZipCode: '90071'
      },
      {
        ...
        rating: 4.8,
        venueName: 'Crystal Palace Ballroom',
        venueAddress: '987 Crystal Court',
        venueCity: 'West Hollywood',
        venueState: 'CA',
        venueZipCode: '90069'
      },
      {
        ...
        rating: 4.4,
        venueName: 'Lakeside Event Center',
        venueAddress: '462 Lakeside Drive',
        venueCity: 'Pasadena',
        venueState: 'CA',
        venueZipCode: '91104'
      }
    ...
    favoriteEvents: [
      {
        ...
        rating: 5,
        venueName: 'LA Convention Center Hall B',
        venueAddress: '1201 South Figueroa Street',
        venueCity: 'Los Angeles',
        venueState: 'CA',
        venueZipCode: '90015'
      },
      {
        ...
        rating: 4.7,
        venueName: 'Universal Event Hall',
        venueAddress: '372 Universal Way',
        venueCity: 'Universal City',
        venueState: 'CA',
        venueZipCode: '91608'
      },
      {
        ...
        rating: 4.8,
        venueName: 'Platinum Events Center',
        venueAddress: '362 Platinum Street',
        venueCity: 'Beverly Hills',
        venueState: 'CA',
        venueZipCode: '90214'
      },
      {
        ...
        rating: 4.9,
        venueName: 'The Getty Center Museum',
        venueAddress: '1200 Getty Center Drive',
        venueCity: 'Los Angeles',
        venueState: 'CA',
        venueZipCode: '90049'
      },
      {
        ...
        rating: 4.6,
        venueName: 'Quantum Events Space',
        venueAddress: '473 Quantum Drive',
        venueCity: 'Pasadena',
        venueState: 'CA',
        venueZipCode: '91105'
      },
      {
        ...
        rating: 4.8,
        venueName: 'Waterfront Event Center',
        venueAddress: '726 Waterfront Street',
        venueCity: 'Marina del Rey',
        venueState: 'CA',
        venueZipCode: '90291'
      },
      {
