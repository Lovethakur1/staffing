  ...
  return (
    <div className="space-y-4 sm:space-y-6 w-full">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div>
          <h1 className="text-2xl lg:text-3xl font-semibold text-foreground">Admin Reports & Analytics</h1>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">admin@xtreme.com, manager@xtreme.com</div>
                  </div>
