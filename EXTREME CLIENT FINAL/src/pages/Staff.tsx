...
export function Staff({ userRole, userId }: StaffProps) {
  ...
  const eventsWithDetails: EventWithDetails[] = useMemo(() => {
    return mockEvents
      .filter(event => event.clientId === userId && event.status === 'completed')
      .map(event => {
      ...
      <div className="desktop-first-header mb-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <Tooltip>
            ...
            <TooltipContent>
              <p>Toggle advanced search and filtering options</p>
            </TooltipContent>
          </Tooltip>
        </div>
      </div>
                    ...
                    <TableCell>
                      <div className="flex items-center justify-center gap-1">
                        <Tooltip>
                          ...
                          <TooltipContent>
                            <p>Rate event and staff performance</p>
                          </TooltipContent>
                        </Tooltip>
                        <Tooltip>
                          <TooltipTrigger asChild>
                          ...
                          <TooltipContent>
                            <p>Book again with same settings</p>
                          </TooltipContent>
                        </Tooltip>
                        <Tooltip>
                          <TooltipTrigger asChild>
                          ...
                          <TooltipContent>
                            <p>View full event details and staff list</p>
                          </TooltipContent>
                        </Tooltip>
                      </div>
                    </TableCell>
