...
export function EquipmentInventory({ userRole }: EquipmentInventoryProps) {
  ...
  const inventory: InventoryItem[] = [
    {
      ...
      assignedTo: ["ST-101", "ST-103", "ST-105"],
      lastRestocked: "2024-09-15"
    },
    {
      id: "INV-002",
      name: "Black Server Shirt (L)",
      category: "uniform",
      sku: "UNI-SHT-BLK-L",
      quantity: 12,
      minStock: 20,
      ...
      status: "low-stock",
      location: "Warehouse A - Shelf 3",
      assignedTo: ["ST-102", "ST-104"],
      lastRestocked: "2024-08-20",
      notes: "Reorder needed ASAP"
    },
    {
      id: "INV-003",
    ...
    },
    {
      ...
      notes: "URGENT: All tables checked out for events. Order more immediately."
    },
    {
      id: "INV-005",
      name: "Black Bow Ties",
      ...
      assignedTo: ["ST-101", "ST-102", "ST-106"],
    ...
    },
    {
      ...
      assignedTo: ["ST-107", "ST-108"],
      lastRestocked: "2024-07-20",
      notes: "Popular item - increase min stock level"
    },
    {
      id: "INV-009",
      name: "Event Signage Stands",
      category: "equipment",
      sku: "EQ-SGN-STD-ADJ",
      quantity: 15,
      minStock: 10,
  ...
  const assignments: Assignment[] = [
    ...
    },
    {
      id: "ASN-002",
      itemId: "INV-004",
      itemName: "Folding Banquet Tables",
      staffId: "ST-102",
      staffName: "Sarah Johnson",
      quantity: 5,
      assignedDate: "2024-10-08",
      status: "checked-out",
      notes: "For Corporate Gala setup"
    },
    {
      id: "ASN-003",
      itemId: "INV-005",
      itemName: "Black Bow Ties",
      staffId: "ST-103",
    ...
    },
    {
      id: "ASN-004",
      itemId: "INV-006",
      itemName: "Portable Speaker System",
      staffId: "ST-104",
      ...
      status: "damaged",
      condition: "Speaker cone damaged during transport",
      notes: "Repair or replacement needed"
    },
    {
      id: "ASN-005",
      itemId: "INV-003",
      ...
      status: "lost",
      notes: "Item not returned after event. Staff charged replacement cost."
    }
  ];
