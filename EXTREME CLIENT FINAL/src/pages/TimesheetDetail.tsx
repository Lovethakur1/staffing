        ...
        <Card className="p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xl font-semibold text-orange-600">{timesheetData.overtimeHours}h</p>
            </div>
          </div>
        </Card>
        ...
        <Card className="lg:col-span-2">
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <p className="text-sm text-muted-foreground mb-1">Overtime Rate</p>
                <p className="font-medium">${timesheetData.overtimeRate.toFixed(2)}/hour</p>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="font-medium text-orange-600">
                  ${(timesheetData.overtimeHours * timesheetData.overtimeRate).toFixed(2)}
                </span>
              </div>
              <div className="flex justify-between items-center text-sm">
                <span className="text-muted-foreground ml-4">{timesheetData.overtimeHours}h × ${timesheetData.overtimeRate}/h</span>
              </div>
                    ...
                    <TableCell>
                      <div>
                        ...
                        {shift.overtimeHours > 0 && (
                          <p className="text-xs text-orange-600">+{shift.overtimeHours}h OT</p>
                        )}
                      </div>
                    </TableCell>
          ...
          <div className="mt-6 p-4 bg-muted/50 rounded-lg">
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              ...
              <div>
                ...
                <p className="text-lg font-semibold">{timesheetData.regularHours}h + {timesheetData.overtimeHours}h</p>
              </div>
              <div>
