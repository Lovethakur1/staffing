        ...
        <div>
          <div className="flex items-center gap-3">
            ...
            <Badge variant="outline" className="flex items-center gap-1">
              ...
              {userRole === 'sub-admin' ? 'Sub-Admin' : userRole === 'manager' ? 'Manager' : userRole === 'client' ? 'Client' : 'Staff'}
            </Badge>
          </div>
          <p className="text-sm lg:text-base text-muted-foreground mt-1">
            {userRole === 'client' ? 'View staff performance ratings and feedback' : 'Track your performance metrics and client feedback'}
          </p>
        </div>
        <div className="flex items-center gap-3">
