  ...
  const staffMembers: Staff[] = [
    {
      ...
      email: 'sarah.m@extremestaffing.com',
      checkInTime: '17:45',
      hoursWorked: 5.25,
      performanceRating: 5,
    },
    {
      ...
      email: 'james.r@extremestaffing.com',
      checkInTime: '17:50',
      hoursWorked: 5.15,
    },
    {
      ...
      email: 'emma.w@extremestaffing.com',
    },
  ];
        ...
        <DialogContent>
          ...
          <div className="space-y-4">
            <div>
              ...
              <TimeInput defaultValue={event.startTime} className="mt-1" />
            </div>
            <div>
              <Label>End Time</Label>
              <TimeInput defaultValue={event.endTime} className="mt-1" />
            </div>
            <div>
